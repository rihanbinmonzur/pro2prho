...
function Users(){
    ...
    const handleSubmit = async(e) =>{
        ...
        try{
            let url ='';
            if (inputs.id!=''){
                url='http://localhost/christmas-api/users_update.php';
            }else{
    ...
    const deleteUser = (id) =>{
        axios.delete(` http://localhost/christmas-api/users_delete.php?id=${id}`).then(function(response){
            getDatas();
        });
    }
            ...
            <form onSubmit={handleSubmit}>
                ...
                <Modal.Body>
                    ...
                    <div className='form-group'>
                        ...
                        <input type='text' defaultValue={inputs.email} className='form-control' name='email'
